...
![3D explanation of Building With python -m build showing the Python mechanism and result](images/04_supplement_2_3d.png)
...
![3D explanation of Checking Before Publishing showing the key comparison or state change](images/04_supplement_3_3d.png)
