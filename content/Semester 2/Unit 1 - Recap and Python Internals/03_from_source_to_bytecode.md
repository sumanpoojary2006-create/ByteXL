...
def expensive_looking():
    return 60 * 60 * 24 * 7    # one week in seconds

dis.dis(expensive_looking)

# Demo:
result = expensive_looking()
print(f"expensive_looking() ->", result)
```
