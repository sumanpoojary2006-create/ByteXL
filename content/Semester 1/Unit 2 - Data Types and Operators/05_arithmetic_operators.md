...
print(10 ** 3)   # 1000  power (10 to the power 3)
```
...
```python
print(17 // 5)   # 3    five fits into seventeen three whole times
print(17 % 5)    # 2    with two left over
```
