...
**Definition:** `uv` is a fast Python project tool that creates virtual environments, installs packages, and records dependencies through one consistent workflow.
