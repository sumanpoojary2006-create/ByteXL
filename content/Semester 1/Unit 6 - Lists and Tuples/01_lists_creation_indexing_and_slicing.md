...
```python
packing_list = ["water bottle", "charger", "ID card", "raincoat", "snacks"]
print(len(packing_list))       # 5
print(packing_list[0])         # water bottle
print(packing_list[2])         # ID card
print(packing_list[-1])        # snacks
```
...
```python
packing_list = ["water bottle", "charger", "ID card", "raincoat", "snacks"]
print(packing_list[1:3])    # ['charger', 'ID card']
print(packing_list[:2])     # ['water bottle', 'charger']
print(packing_list[2:])     # ['ID card', 'raincoat', 'snacks']
```
