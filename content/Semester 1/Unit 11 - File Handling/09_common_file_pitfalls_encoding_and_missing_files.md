...
log_file = Path("attendees_day4.txt")

if log_file.exists():
    print(log_file.read_text())
else:
    print("No log found for day 4 yet.")
```
...
with open("receipt.txt", "w", encoding="utf-8") as file:
    file.write("Total: ₹1500\n")

with open("receipt.txt", "r", encoding="utf-8") as file:
    print(file.read())    # Total: ₹1500
```
...
receipt.write_text("Total: ₹1500\n", encoding="utf-8")
print(receipt.read_text(encoding="utf-8"))
print("Habit: specify encoding='utf-8' every time, even via pathlib.")
```
...
print(read_log_safely("fest_log.txt"))           # a real file -> its contents
print(read_log_safely("nonexistent_file.txt"))   # missing -> graceful message
```
