...
# Show exactly what landed in the file
...
print(loaded_stalls)
print(loaded_stalls["Food"]["Samosa"])    # 30
```
...
fest_stalls = {"Merch": {"T-shirt": 350}}

text = json.dumps(fest_stalls, indent=2)
print(text)

restored = json.loads(text)
print(restored["Merch"]["T-shirt"])    # 350
```
...
data = {"coordinates": (15.2993, 74.1240)}
text = json.dumps(data)
print(text)    # {"coordinates": [15.2993, 74.124]}
```
...
for stall, items in reloaded.items():
    print(f"--- {stall} ---")
