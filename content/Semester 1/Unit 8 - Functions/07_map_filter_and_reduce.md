...
print(with_late_fee)    # [315.0, 157.5, 472.5, 210.0]
```
...
```python
with_late_fee = [315.0, 157.5, 472.5, 210.0]
above_200 = list(filter(lambda amount: amount > 200, with_late_fee))
print(above_200)    # [315.0, 472.5, 210.0]
```
...
```python
with_late_fee = [315.0, 157.5, 472.5, 210.0]
above_200 = [amount for amount in with_late_fee if amount > 200]
print(above_200)
```
...
total = reduce(lambda running_total, amount: running_total + amount, above_200)
print(total)    # 997.5
```
