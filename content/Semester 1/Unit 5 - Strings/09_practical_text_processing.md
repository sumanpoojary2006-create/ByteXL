...
print("Characters (no spaces):", len(text.replace(" ", "")))
print("Contains 'fox'?", "fox" in text)
```
...
keyword = input("Search for which word? ")

clean = sentence.strip()
print("Word count:", len(clean.split()))
print("Character count (no spaces):", len(clean.replace(" ", "")))
print("In upper case:", clean.upper())
print(f"Contains '{keyword}'?", keyword.lower() in clean.lower())
```
