...
print(f"Population: {population:,}")     # Population: 1,380,000,000

ratio = 0.8734
print(f"Score: {ratio:.1%}")             # Score: 87.3%
```
...
```python
print("{} is {} years old.".format("Asha", 20))    # the older .format() style
print("%s is %d years old." % ("Asha", 20))         # the even older % style
print(f"{'Asha'} is {20} years old.")                # the modern, preferred f-string style
```
