...
```python
day1 = {"A101", "A102", "A103", "A104"}
day2 = {"A103", "A104", "A105"}

all_attendees = day1 | day2
print(all_attendees)    # all five IDs, A101 through A105, order not guaranteed
```
...
both_days = day1 & day2
print(both_days)    # A103 and A104, order not guaranteed
```
...
only_day1 = day1 - day2
print(only_day1)    # A101 and A102, order not guaranteed

only_day2 = day2 - day1
print(only_day2)    # {'A105'}
```
...
exactly_one_day = day1 ^ day2
print(exactly_one_day)    # A101, A102, and A105, order not guaranteed
```
...
```python
day1 = set(input("Day 1 attendee IDs, space separated: ").split())
day2 = set(input("Day 2 attendee IDs, space separated: ").split())

print("Came both days:", day1 & day2)
print("Only day 1:", day1 - day2)
print("Only day 2:", day2 - day1)
print("Total unique attendees:", len(day1 | day2))
```
