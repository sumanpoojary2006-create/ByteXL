...
```python
attendees = {"A101", "A102", "A101", "A103", "A102"}
print(attendees)    # {'A101', 'A102', 'A103'} - just the three unique IDs, in some order
```
...
```python
scanned_today = set()
print(type(scanned_today))    # <class 'set'>
```
...
```python
attendees = {"A101", "A102", "A103"}
print("A101" in attendees)    # True
print("A999" in attendees)    # False
```
...
```python
scans = ["A101", "A102", "A101", "A103", "A102", "A101"]
unique_attendees = set(scans)
print(unique_attendees)         # the three unique IDs, order not guaranteed
print(len(scans))               # 6, every beep
print(len(unique_attendees))    # 3, every distinct person
```
...
scans = []
for _ in range(5):
    scans.append(input("Scan a wristband ID: "))

unique_attendees = set(scans)
print("Total scans:", len(scans))
print("Unique attendees:", len(unique_attendees))
