"""Build the benchmark-quality Unit 3 MCQ workbook from canonical JSON."""
...
DATA_FILE = os.path.join(OUT_DIR, "unit3_questions.json")
...
def build_rows(questions):
    ...
    for item in questions:
        counters[item["set"]] += 1
        rows.append([
            f"Python - MCQ - 3.{item['set']}.{counters[item['set']]}",
