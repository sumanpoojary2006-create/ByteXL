...
const UNIT = 9;
const TITLE = "Basic Object-Oriented Programming";
const TOPIC = "object-oriented-programming-intro";
const SHEET_NAME = "Python - MCQ - 9";
const UNIT_DIR = path.join(
  ROOT,
  "content/Question Bank/MCQ/Python/Unit 9 - Basic Object-Oriented Programming",
);
const DATA_FILE = path.join(UNIT_DIR, "unit9_questions.json");
const TEMPLATE_FILE = path.join(
  ROOT,
  "content/Question Bank/Template/questions-mcq-template.xlsx",
);
const CONTENT_FILE = path.join(UNIT_DIR, "Unit 9 - Basic Object-Oriented Programming - MCQ.xlsx");
const DELIVERY_DIR = path.join(ROOT, "outputs/units-6-13-qc-upgrade");
const DELIVERY_FILE = path.join(DELIVERY_DIR, "Unit 9 - Basic Object-Oriented Programming - MCQ.xlsx");
const PREVIEW_FILE = path.join(DELIVERY_DIR, "Unit 9 - Basic Object-Oriented Programming - MCQ.png");
...
function validateQuestions(questions) {
  const allowedSubtopics = new Set([
    "attributes-and-methods", "classes-and-objects",
    "constructors", "modeling-with-classes",
  ]);
  ...
  assert(new Set(questions.slice(0, 10).map((question) => question.subtopic)).size === 4, "Set 1 must cover all four Unit 9 taxonomy subtopics");
